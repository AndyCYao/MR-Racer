...
{
    // BridgeEngineUnity Assigned Properties
    ...
    internal void UpdateTracker() 
    {
        ...
        trackerUpdateInterop.scale = new beVector3(Vector3.one);
        
        trackerUpdateInterop.cameraTextureInfo.texturePtr = IntPtr.Zero;
